...
function InvoiceCreation({ onHide, invdata, setInvoices, invoices }) {
  ...
  const [customername, setCustomername] = useState(invdata?.customername || "");
  ...
  const [id, setId] = useState(invdata?._id);
